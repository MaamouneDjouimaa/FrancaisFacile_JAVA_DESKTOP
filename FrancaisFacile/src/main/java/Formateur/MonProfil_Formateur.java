...
import Apprenant.MonProfilModife;
import Apprenant.Deconnexion;
 ...
 */
public class MonProfil_Formateur extends javax.swing.JFrame {

    /**
     * Creates new form Principale
     */
    public MonProfil_Formateur() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MonProfil_Formateur.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MonProfil_Formateur().setVisible(true);
            }
        });
    }
