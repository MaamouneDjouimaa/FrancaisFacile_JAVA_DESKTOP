 ...
 */
public class Reunion_Formateur extends javax.swing.JFrame {

    /**
     * Creates new form Principale
     */
    public Reunion_Formateur() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reunion_Formateur.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Reunion_Formateur().setVisible(true);
            }
        });
    }
