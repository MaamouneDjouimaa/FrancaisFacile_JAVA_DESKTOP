 ...
 */
public class Messagerejoindre extends javax.swing.JFrame {

    /**
     * Creates new form Principale
     */
    public Messagerejoindre() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Réunion indisponible");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Messagerejoindre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Messagerejoindre().setVisible(true);
            }
        });
    }
