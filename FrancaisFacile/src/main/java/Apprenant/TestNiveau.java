 ...
 */
public class TestNiveau extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel26.setText("Type de tests :");
        ...
        jButton6.setText("Compréhension orale");
        ...
        jButton7.setText("Structure de la langue");
        ...
        jButton8.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 20)); // NOI18N
        jButton8.setForeground(new java.awt.Color(0, 0, 204));
        jButton8.setText("Compréhension écrite");
    ...
    private void MonProfilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MonProfilActionPerformed
        // TODO add your handling code here:
        TestNiveau nextInterface = new TestNiveau();
        nextInterface.setVisible(true);
        setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TestNiveau.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TestNiveau().setVisible(true);
            }
        });
    }
