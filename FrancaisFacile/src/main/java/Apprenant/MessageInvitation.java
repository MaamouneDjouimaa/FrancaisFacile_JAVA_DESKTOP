 ...
 */
public class MessageInvitation extends javax.swing.JFrame {

    /**
     * Creates new form Principale
     */
    public MessageInvitation() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Invitation envoyée avec succès !");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MessageInvitation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MessageInvitation().setVisible(true);
            }
        });
    }
