...
import Formateur.Accueil_Formateur;
 ...
 */
public class ConnexionEffectueeFormateur extends javax.swing.JFrame {

    /**
     * Creates new form Principale
     */
    public ConnexionEffectueeFormateur() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConnexionEffectueeFormateur.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConnexionEffectueeFormateur().setVisible(true);
            }
        });
    }
