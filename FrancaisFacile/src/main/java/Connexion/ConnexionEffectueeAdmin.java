 ...
 */
public class ConnexionEffectueeAdmin extends javax.swing.JFrame {

    /**
     * Creates new form Principale
     */
    public ConnexionEffectueeAdmin() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConnexionEffectueeAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConnexionEffectueeAdmin().setVisible(true);
            }
        });
    }
