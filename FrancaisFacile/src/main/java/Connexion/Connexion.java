...
public class Connexion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Logo45.png"))); // NOI18N
        ...
        jTextField1.addFocusListener(new FocusListener() {
            ...
            public void focusGained(FocusEvent e) {
                if(jTextField1.getText().equals("exemple@gmail.com")) {
                    jTextField1.setText("");
                }
            }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        //TODO add your handling code here:
        if(jTextField1.getText().equals("apprenant")) {
            // create and display the next interface
            ...
            // create and display the next interface
            ConnexionEffectueeAdmin nextInterface = new ConnexionEffectueeAdmin();
            nextInterface.setVisible(true);
            setVisible(false);
            }
            else{
                if(jTextField1.getText().equals("formateur")) {
                // create and display the next interface
                ConnexionEffectueeFormateur nextInterface = new ConnexionEffectueeFormateur();
                nextInterface.setVisible(true);
                setVisible(false);
                }
            }
